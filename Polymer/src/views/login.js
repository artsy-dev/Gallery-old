  ...
  render() {
    return html`
      ...
      <paper-material elevation="2" id="login-card">
        <login-container
          active-side="${["login", "account-recovery"].includes(this._page.id)
            ? "right"
            : "left"}"
        >
          <div slot="left" class="side-panel">
            <div class="content-container">
              ...
              <div class="link-container">
                <router-link class="underline" page-id="account-recovery"
                  >Forgot your password?</router-link
                >
              </div>
              <paper-button>Sign in</paper-button>
              <div class="link-container page-switch">
                <router-link page-id="register" class="underline"
          ...
          <div slot="right" class="side-panel">
            <div class="content-container">
              ...
              <div class="link-container page-switch">
                <router-link class="underline" page-id="login"
